...
import { 
  ...
  BarChart3, AlertOctagon, Server, Check
} from 'lucide-react';
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Introdu CUI sau denumire companie (ex: 25059607 sau SMARTFLIX)..."
              className="w-full pl-11 pr-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-full text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            />
          </div>
          <button
            onClick={() => handleLaunchInvestigation()}
