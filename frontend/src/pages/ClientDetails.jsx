        ...
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2.5">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white truncate tracking-tight">{client.name}</h3>
              {client.type === 'PJ' && (
                <button
                  type="button"
              ...
              <div className="w-full bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mt-6 animate-in fade-in">
                ...
                {latestEval.raw_financial_data && JSON.parse(latestEval.raw_financial_data) && JSON.parse(latestEval.raw_financial_data).personnel && (
                  <div className="mt-8 border-t border-gray-100 dark:border-gray-800 pt-6">
                          ...
                          <div className="overflow-x-auto border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 shadow-xs">
                            <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                              <thead className="text-xs text-gray-500 uppercase bg-gray-50/80 dark:bg-gray-900/60 border-b border-gray-200 dark:border-gray-700">
                                <tr>
                                  ...
                                  <th className="px-4 py-3 text-right whitespace-nowrap">Acțiuni (Caracatița)</th>
                                </tr>
                              </thead>
                                    ...
                                    <tr key={idx} className={`hover:bg-gray-50/60 dark:hover:bg-gray-700/30 transition-colors ${isSelected ? 'bg-primary/5 dark:bg-primary/10' : ''}`}>
                                      ...
                                      <td className="px-4 py-2.5 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                        <div className="flex items-center gap-1.5">
                                          <button
                                            ...
                                            title="Deschide dosar complet &amp; Caracatița pentru această persoană"
                                          >
                                      ...
                                      <td className="px-4 py-2.5 text-center whitespace-nowrap">
                                        {person.cota_participare > 0 ? (
                                          <span className="px-2 py-0.5 rounded-md bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 font-bold font-mono text-xs">
                                      ...
                                      <td className={`px-4 py-2.5 text-center font-medium font-mono whitespace-nowrap ${person.alte_companii_active > 3 ? 'text-orange-500 font-bold' : ''}`}>
                                        {person.alte_companii_active}
                                      </td>
                                      <td className="px-4 py-2.5 text-center font-medium font-mono whitespace-nowrap">
                                      ...
                                      <td className="px-4 py-2.5 text-right whitespace-nowrap">
                                        <button
                                          ...
                                          title="Deschide investigația rețelei („Caracatița”)"
                                        >
                                          <Network size={14} className="text-primary group-hover:text-white" />
                                          <span className="pr-1">Caracatița</span>
                                        </button>
                                      </td>
                                    </tr>
                                  );
                            ...
                            <div className="p-3 bg-gray-50/80 dark:bg-gray-900/60 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500 dark:text-gray-400">
                              <div className="flex items-center gap-2">
                                ...
                                <span>Total: <strong className="text-gray-900 dark:text-white font-mono">{totalPersonnel}</strong> asociați / administratori</span>
                              </div>
                    ...
                    {/* Portofoliu Firme & Rețea Asociați & Conducere („Caracatița”) */}
                    <div className="mt-8 border-t border-gray-100 dark:border-gray-800 pt-6">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                        <div>
                          <h4 className="font-bold text-gray-900 dark:text-white flex items-center gap-2 text-base">
                            <Briefcase size={18} className="text-primary" /> Portofoliu Firme &amp; Rețea Asociați &amp; Conducere („Caracatița”)
                          </h4>
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                      ...
                                      <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                        {person.firme?.map((f, fIdx) => (
                                          <tr key={fIdx} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/40 transition-colors">
                                            <td className="px-3 py-2 font-mono text-gray-400 whitespace-nowrap">{fIdx + 1}</td>
                                            ...
                                            <td className="px-3 py-2 font-mono text-gray-600 dark:text-gray-300 whitespace-nowrap">{f.cui}</td>
                                            ...
                                            <td className="px-3 py-2 text-center font-medium font-mono whitespace-nowrap">{f.procent !== null && f.procent !== undefined ? `${f.procent}%` : '-'}</td>
                                  ...
                                  <table className="w-full text-left text-xs">
                                    ...
                                    <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                      {person.firme?.map((f, fIdx) => {
                                        ...
                                        return (
                                          <tr key={fIdx} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/40 transition-colors">
                                            <td className="px-4 py-2.5 font-mono text-gray-400 whitespace-nowrap">{fIdx + 1}</td>
                                            ...
                                            <td className="px-4 py-2.5 text-center font-semibold text-gray-800 dark:text-gray-200 whitespace-nowrap font-mono">
                          ...
                          {streetView360Mode ? (
                            ...
                            <div className="flex flex-col">
                              ...
                              >
                                ...
                                {/* Etichetă Unghi */}
                                <div className="absolute top-2.5 left-2.5 px-3 py-1 bg-black/85 text-white text-xs font-mono rounded-full border border-white/10 shadow-sm z-10">
                                  {activePhoto.title}
                                </div>

                                {/* Data Captură Google Street View din Metadata */}
                                <div className="absolute top-2.5 right-24 px-2.5 py-1 bg-black/85 text-emerald-400 text-xs font-mono rounded-full border border-emerald-500/30 shadow-sm z-10 flex items-center gap-1">
                                ...
                                <div className="absolute bottom-2.5 left-2.5 px-3 py-1 bg-black/85 text-gray-300 text-xs font-mono rounded-full border border-white/10 shadow-sm z-10 flex items-center gap-1.5">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mt-6 animate-in fade-in">
                      ...
                      <div className="mb-4 p-3 rounded-2xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-between gap-3 text-xs text-gray-900 dark:text-white animate-pulse">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold">
                            Se rulează evaluarea pentru CUI: <span className="font-mono underline">{evaluatingCui}</span>...
                          </span>
                        </div>
                    ...
                    <div className="overflow-x-auto border border-gray-200 dark:border-gray-700 rounded-2xl bg-white dark:bg-gray-800 shadow-xs mt-4">
                      <table className="w-full text-left text-xs">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-700/60 font-mono text-gray-700 dark:text-gray-300">
